...
# 2 "<built-in>" 2
# 1 "nlms_filter/top.cpp" 2
# 1 "nlms_filter/top.hpp" 1



# 1 "/tools/Xilinx/Vitis_HLS/2022.1/common/technology/autopilot/ap_fixed.h" 1
# 55 "/tools/Xilinx/Vitis_HLS/2022.1/common/technology/autopilot/ap_fixed.h"
...
# 56 "/tools/Xilinx/Vitis_HLS/2022.1/common/technology/autopilot/ap_fixed.h" 2
...
# 57 "/tools/Xilinx/Vitis_HLS/2022.1/common/technology/autopilot/ap_int.h"
...
# 5 "nlms_filter/top.hpp" 2
# 34 "nlms_filter/top.hpp"
...
#pragma HLS TOP name=nlms_top
 ...
 nlms_outer_loop:for(int j=0; j<10; j++){
#pragma HLS PIPELINE off
 nlms_inner_loop:for (int i=0; i<128; i++){
#pragma HLS PIPELINE
 estimation[i] = weights[i] * input_signal[i];
   error[i] = desired_signal[i] - estimation[i];
   weights[i] = weights[i] + (1/(0.0001 + input_signal[i] * input_signal[i])) * input_signal[i] * error[i];
